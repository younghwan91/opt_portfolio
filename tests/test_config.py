...
class TestAllocationConfig:
    ...
    def test_from_weights_valid(self):
        ...
        config = AllocationConfig.from_weights(vaa=0.4, spy=0.15, tlt=0.15, gld=0.15, bil=0.15)
    ...
    def test_from_weights_invalid(self):
        ...
        with pytest.raises(ValueError):
            AllocationConfig.from_weights(vaa=0.5, spy=0.2, tlt=0.2, gld=0.2, bil=0.2)
...
class TestMomentumConfig:
    ...
    def test_weight_sum(self):
        ...
        total = MOMENTUM.WEIGHT_1M + MOMENTUM.WEIGHT_3M + MOMENTUM.WEIGHT_6M + MOMENTUM.WEIGHT_12M
        assert total == 19
