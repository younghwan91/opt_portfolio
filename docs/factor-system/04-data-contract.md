...
유료 티어(사용자 확인): $30 = 5년 / $49 = 10년 / $69 = 풀.
티어 선택 근거는 `06-provider-review.md`, 필요 Sharpe 계산은 `05-math-spec.md` 참조.

**결제 전 남은 확인 1건**: 히스토리와 별개로 **유니버스(상장폐지 포함 전체
16,000종목)가 어느 티어부터 오는지**. 풀 히스토리를 사도 현재 구성종목뿐이면
생존편향은 그대로다.
...
S&P500 5년 기준 정상값: 종목당 1,237거래일 / mcap 결측 0 / 종목당 19.8분기.
